...
<style>
    ...
    * { color: var(--text) !important; }
    body, .bg-white { background-color: var(--dark-bg) !important; color: white !important; }
    .bg-gray-100, .bg-gray-200 { background-color: var(--darker-bg) !important; }
    .border-gray-300, .border-gray-200 { border-color: var(--border) !important; }
    input, select, textarea { background-color: var(--dark-bg) !important; color: white !important; }
    input::placeholder, select option { color: #9CA3AF !important; }
    .text-gray-600, .text-gray-500, .text-gray-700 { color: #D1D5DB !important; }
    .text-gray-800, .text-gray-900 { color: white !important; }
    .text-gold { color: var(--gold) !important; }
    .bg-gold { background-color: var(--gold) !important; }
    .border-gold { border-color: var(--gold) !important; }
    .hover\:shadow-gold\/20:hover { box-shadow: 0 10px 30px rgba(255, 215, 0, 0.2); }
    .spinner {
        width: 40px; height: 40px; border: 4px solid #36454F; border-top: 4px solid #FFD700;
