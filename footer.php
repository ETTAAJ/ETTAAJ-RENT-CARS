...
<footer class="bg-gray-900 text-white py-12 mt-20 relative overflow-hidden">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
      ...
      <!-- Quick Links -->
      <div>
        <h3 class="text-gold font-semibold text-lg mb-5">Quick Links</h3>
        <ul class="space-y-3 text-gray-400">
          <li><a href="index.php" class="hover:text-gold transition text-sm md:text-base">Home</a></li>
          <li><a href="index.php#cars" class="hover:text-gold transition text-sm md:text-base">Browse Cars</a></li>
          <li><a href="about.php" class="hover:text-gold transition text-sm md:text-base">About Us</a></li>
          <li><a href="contact.php" class="hover:text-gold transition text-sm md:text-base">Contact</a></li>
        </ul>
      </div>

      <!-- Contact Info - WhatsApp Icon Fixed! -->
      <div>
        <h3 class="text-gold font-semibold text-lg mb-5">Contact</h3>
    ...
    <div class="border-t border-gray-800 pt-8 text-center">
      <p class="text-xs md:text-sm text-gray-500">
        © 2025 ETTAAJ RENT CARS. All rights reserved. &nbsp; | &nbsp;
