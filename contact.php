...
<main class="max-w-7xl mx-auto px-4 py-16 lg:py-24">
  <!-- Page Title -->
  <div data-aos="fade-up" class="text-center mb-16">
    <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-primary">
      Let's Connect
    </h1>
    <p class="text-lg md:text-xl text-muted mt-4 max-w-3xl mx-auto leading-relaxed">
  ...
  <div class="grid lg:grid-cols-2 gap-12 xl:gap-16">
    ...
    <div data-aos="fade-right" data-aos-delay="100">
      <div class="space-y-8">
        <h2 class="text-2xl md:text-3xl font-semibold text-primary">Visit Us in Casablanca</h2>

        <!-- Google Maps Embed -->
        <div class="rounded-2xl overflow-hidden shadow-2xl h-64 md:h-80 border border-border">
          <iframe 
        ...
        <!-- Contact Details -->
        <div class="grid sm:grid-cols-1 gap-6 text-muted">
          <div class="flex items-start group">
            ...
            <div>
              <p class="font-medium text-primary">Office Location</p>
              <p class="text-muted">123 Boulevard Mohamed V, Casablanca, Morocco</p>
            </div>
          </div>
    ...
    <div data-aos="fade-left" data-aos-delay="200">
      <form action="contact-process.php" method="POST" 
            class="bg-card/90 backdrop-blur-md p-8 md:p-10 rounded-2xl shadow-2xl border border-border space-y-6">

        <div class="relative">
          <input type="text" name="name" id="name" required
                 class="peer w-full p-4 bg-card-dark border border-border text-primary rounded-xl focus:ring-2 focus:ring-gold focus:border-gold transition placeholder-muted">
          <label for="name" class="absolute left-4 -top-3 bg-card px-2 text-sm font-medium text-muted transition-all 
                       peer-placeholder-shown:top-4 peer-placeholder-shown:text-base peer-placeholder-shown:text-muted 
                       peer-focus:-top-3 peer-focus:text-sm peer-focus:text-gold">
            Your Name
          </label>
        </div>
        ...
        <div class="relative">
          <input type="email" name="email" id="email" required
                 class="peer w-full p-4 bg-card-dark border border-border text-primary rounded-xl focus:ring-2 focus:ring-gold focus:border-gold transition placeholder-muted">
          <label for="email" class="absolute left-4 -top-3 bg-card px-2 text-sm font-medium text-muted transition-all 
                       peer-placeholder-shown:top-4 peer-placeholder-shown:text-base peer-placeholder-shown:text-muted 
                       peer-focus:-top-3 peer-focus:text-sm peer-focus:text-gold">
            Your Email
          </label>
        ...
        <div class="relative">
          <textarea name="message" id="message" rows="5" required
                    class="peer w-full p-4 bg-card-dark border border-border text-primary rounded-xl focus:ring-2 focus:ring-gold focus:border-gold transition resize-none placeholder-muted"></textarea>
          <label for="message" class="absolute left-4 -top-3 bg-card px-2 text-sm font-medium text-muted transition-all 
                       peer-placeholder-shown:top-4 peer-placeholder-shown:text-base peer-placeholder-shown:text-muted 
                       peer-focus:-top-3 peer-focus:text-sm peer-focus:text-gold">
            Your Message
          </label>
        ...
        <button type="submit"
                class="w-full bg-gradient-to-r from-gold to-yellow-500 hover:from-yellow-500 hover:to-orange-400 
                       text-primary font-bold py-4 rounded-xl shadow-xl transition-all duration-300 
...
<a href="https://wa.me/212772331080?text=Hi%20ETTAAJ%20RENT%20CARS%2C%20I%20want%20to%20rent%20a%20car!"
  ...
  <span class="absolute -top-12 left-1/2 transform -translate-x-1/2 bg-card-dark text-primary text-xs rounded-full px-3 py-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap pointer-events-none border border-border">
