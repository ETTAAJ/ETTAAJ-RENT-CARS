...
<head>
  ...
  <title>Contact ETTAAJ RENT CARS | 24/7 Car Rental Marrakech</title>
  <meta name="description" content="Contact ETTAAJ RENT CARS in Marrakech. WhatsApp or call +212 772 331 080 – 24/7 support." />
...
<main class="max-w-7xl mx-auto px-6 py-16 lg:py-24">
  ...
  <div data-aos="fade-up" class="text-center mb-16">
    <h1 class="text-5xl md:text-6xl font-bold mb-4">Let's Connect</h1>
    <p class="text-xl text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">
      Ready to rent your dream car in Marrakech? We're available 24/7.
    </p>
  </div>
  ...
  <div class="grid lg:grid-cols-2 gap-12 xl:gap-20">
    ...
    <div data-aos="fade-right" class="space-y-10">
      ...
      <h2 class="text-3xl font-bold">Visit Us in Marrakech</h2>

      <div class="rounded-2xl overflow-hidden shadow-2xl border border-gray-200 dark:border-gray-800">
        <!-- REAL LOCATION - Gueliz, near Avenue Mohamed VI -->
        <iframe 
      ...
      <div class="space-y-8">
        <div class="flex items-start gap-4">
          ...
          <div>
            <p class="font-bold text-black dark:text-white">Office Location</p>
        ...
        <div class="flex items-start gap-4">
          ...
          <div>
            <p class="font-bold text-black dark:text-white">Phone & WhatsApp</p>
            <a href="https://wa.me/212772331080" class="text-gold text-xl font-bold hover:underline">+212 772 331 080</a>
          </div>
        </div>
      </div>
    ...
    <div data-aos="fade-left">
      <form action="contact-process.php" method="POST" class="bg-gray-50 dark:bg-gray-900/90 border border-gray-200 dark:border-gray-800 rounded-3xl p-8 lg:p-12 shadow-2xl">
        ...
        <div class="relative mb-10">
          <textarea name="message" id="message" rows="6" required
                    class="peer w-full px-5 py-5 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-2xl text-black dark:text-white text-lg focus:outline-none focus:ring-2 focus:ring-gold focus:border-gold transition resize-none placeholder-transparent"></textarea>
          <label for="message" class="absolute left-5 -top-3 bg-gray-50 dark:bg-gray-900 px-3 text-sm font-medium text-gray-700 dark:text-gray-300 transition-all peer-placeholder-shown:top-5 peer-placeholder-shown:text-lg peer-placeholder-shown:text-gray-500 peer-focus:-top-3 peer-focus:text-gold peer-focus:text-sm">
            Your Message
          </label>
        </div>
      ...
      <div class="text-center mt-10">
        <p class="text-gray-700 dark:text-gray-300 mb-5">Or contact us instantly</p>
        <a href="https://wa.me/212772331080?text=Hi%20ETTAAJ%20RENT%20CARS!%0AI'm%20interested%20in%20renting%20a%20car." 
           target="_blank"
...
<a href="https://wa.me/212772331080?text=Hi%20ETTAAJ%20RENT%20CARS!%0AI'm%20interested%20in%20renting%20a%20car." target="_blank"
